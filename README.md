...
5. **Backend Setup** (Optional for demo mode)
...
#### **Intelligent Dummy Report Generation**
When users enter custom queries, the system generates sophisticated dummy reports with:

- **Query-Specific Summaries**: AI-generated summaries tailored to the research topic with relevant industry context
...
- **Realistic Source Citations**: Academic and industry source URLs that appear legitimate and research-oriented
- **Dynamic Content Adaptation**: Report content adapts based on keywords in the query (AI, quantum, blockchain, healthcare, climate, etc.)
